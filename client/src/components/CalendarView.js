...
export const CalendarView = () => {
  ...
  return (
    <div className="my-12" style={{"backgroundColor":"white"}}>
      ...
      <div className="max-w-md px-4 mx-auto sm:px-7 md:max-w-7xl md:px-6 ">
        <div className="md:grid md:grid-cols-5 md:divide-x  md:divide-gray-300">
          ...
          Filters </h1> */}
              <h2
                class="text-xl font-bold mb-4 text-indigo-700 -mt-1"
                style={{ color: "#6d7f69" }}
              >
                By Hall Name
              </h2>
          ...
          <div className="md:px-7 col-span-2" style={{"background-color":"rgb(250, 250, 250, 0.4)","backdrop-filter":"blur(9px)"}}>
